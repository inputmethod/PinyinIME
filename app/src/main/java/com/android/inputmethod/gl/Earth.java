...
import static com.android.inputmethod.gl.ShaderUtil.createProgram;
...
public class Earth {
    ...
    public void drawSelf(int texId,int texIdNight) {        
         ...
         GLES30.glBindTexture(GLES30.GL_TEXTURE_2D, texId);  //绑定白天纹理
         GLES30.glActiveTexture(GLES30.GL_TEXTURE1);
         GLES30.glBindTexture(GLES30.GL_TEXTURE_2D, texIdNight);  //绑定黑夜纹理           
